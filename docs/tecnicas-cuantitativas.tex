...
\label{tab:table-probability-functions}Funciones para distribución de probabilidades in R.
...
\includegraphics{tecnicas-cuantitativas_files/figure-latex/unnamed-chunk-49-1.pdf}

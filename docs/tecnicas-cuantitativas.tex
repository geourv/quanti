...
\begin{figure}
\centering
\includegraphics{tecnicas-cuantitativas_files/figure-latex/regression0-1.pdf}
\caption{\label{fig:regression0}Diagrama de dispersión que muestra el mal humor en función de las horas de sueño.}
\end{figure}

\begin{figure}
\centering
\includegraphics{tecnicas-cuantitativas_files/figure-latex/regression1a-1.pdf}
...
\begin{figure}
\centering
\includegraphics{tecnicas-cuantitativas_files/figure-latex/regression1b-1.pdf}
...
\begin{figure}
\centering
\includegraphics{tecnicas-cuantitativas_files/figure-latex/regression3a-1.pdf}
\caption{\label{fig:regression3a}Una descripción de los residuos asociados con la línea de regresión que mejor se ajusta}
\end{figure}

\begin{figure}
\centering
\includegraphics{tecnicas-cuantitativas_files/figure-latex/regression3b-1.pdf}

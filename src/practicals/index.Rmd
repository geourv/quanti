...
# Presentación
Esta guía de inicio rápido está diseñada para ayudarlo a entregar sus pruebas de monitoreo con Markdown y R-studio. Contiene los conceptos básicos para preparar un documento que incluye el código y la salida R. El documento final incluirá el contenido de la prueba de seguimiento en un estilo adecuado e inteligente. 

## Prerrequisitos
Para preparar las pruebas de seguimiento o cualquier otra tarea en este formato es necesario instalar primero R y RStudio con los paquetes knitr y rmarkdown.
...
al hacer clic en `knitr a HTML` se crea un archivo .html con este contenido.
...
### Cabecera
Está en la parte superior del documento dentro de estas dos líneas `---`
